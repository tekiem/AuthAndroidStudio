...
public class UpdateProfile extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == PICK_IMAGE && resultCode == RESULT_OK && data.getData() != null){
            ...
            try {
                ...
                updateProfileImage.setImageBitmap(bitmap);
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newUserName = findViewById(R.id.EditName);
        newUserEmail = findViewById(R.id.EditEmail);
        newUserAge = findViewById(R.id.EditAge);
        save = findViewById(R.id.EditSave);
        updateProfileImage = findViewById(R.id.ImageUpdate);
        ...
        storageReference.child(firebaseAuth.getUid()).child("Images/Photo de profil").getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onSuccess(Uri uri) {
                Picasso.get().load(uri).fit().centerCrop().into(updateProfileImage);
            }
        });
            ...
            public void onClick(View v) {
                ...
                uploadTask.addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        Toast.makeText(UpdateProfile.this,"Upload Sucessful!!!",Toast.LENGTH_SHORT).show();
                    }
                });
                finish();
            }
